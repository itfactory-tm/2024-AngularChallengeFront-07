...
export class ArtistService {
  ...
  getArtistByIdApi(id: number): Observable<Artist> {
    return this.httpClient.get<Artist>("http://localhost:3000/artists/" + id);
  }
  ...
  postArtist(artist: Artist): Observable<Artist> {
    ...
    return this.httpClient.post<Artist>("http://localhost:3000/artists", artist, { headers: headers });
  }
  ...
  putArtist(id: number, artist: Artist): Observable<Artist> {
    ...
    return this.httpClient.put<Artist>("http://localhost:3000/artists/" + id, artist, { headers: headers });
  }

  deleteArtist(id: number): Observable<Artist> {
    return this.httpClient.delete<Artist>("http://localhost:3000/artists/" + id);
  }
}
